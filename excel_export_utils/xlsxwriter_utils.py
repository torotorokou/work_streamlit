"""
DataFrameをXlsxWriterエンジンで整形してExcelに出力するユーティリティ
"""
...
def convert_df_to_excel_bytes(df: pd.DataFrame) -> BytesIO:
    ...
    with pd.ExcelWriter(output, engine="xlsxwriter") as writer:
        ...
        unit_price_format = workbook.add_format(  # type: ignore
...
def simple_export_to_excel(df: pd.DataFrame, sheet_name: str = "データ") -> bytes:
    """
