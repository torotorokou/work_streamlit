...
def centered_button(label: str, key: str | None = None, disabled: bool = False) -> bool:
    """
...
def centered_download_button(
    ...
    Parameters:
        label (str): ボタンに表示するテキスト
        data (BytesIO | bytes): ダウンロードするデータ（バイナリ）
